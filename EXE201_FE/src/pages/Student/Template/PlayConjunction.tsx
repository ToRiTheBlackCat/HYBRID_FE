            ...
            {courseMinigames.map((mg, index) => {
              ...
              return (
                <button
                  ...
                  className={`w-full flex items-center gap-4 text-left p-4 m-1 rounded-xl transition-all duration-300 hover:scale-[1.02] ${
                    isActive 
              ...
              <div className="flex items-center justify-between flex-wrap gap-6 mb-6">
                ...
                <div className="flex items-center gap-6">
                  ...
                  <button
                    ...
                    className={`px-6 py-3 rounded-2xl font-semibold transition-all duration-300 flex items-center gap-3 shadow-lg hover:shadow-xl transform hover:scale-105 ${
                      isPaused
