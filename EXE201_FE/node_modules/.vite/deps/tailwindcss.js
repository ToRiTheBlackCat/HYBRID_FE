...
var ze = (_a = class {
  ...
  getOptions(t) {
    var _a2;
    return t = pe2(__privateMethod(this, _ze_instances, r_fn).call(this, t)), ((_a2 = this.values.get(t)) == null ? void 0 : _a2.options) ?? 0;
  }
  entries() {
  ...
  markUsedVariable(t) {
    let i = pe2(__privateMethod(this, _ze_instances, r_fn).call(this, t)), e = this.values.get(i);
    if (!e) return false;
    let o = e.options & 16;
  ...
  resolveWith(t, i, e = []) {
    ...
    return l3.options & 1 ? [l3.value, s2] : [__privateMethod(this, _ze_instances, t_fn).call(this, o), s2];
  }
  namespace(t) {
...
function I2(r, t, i = [], e = {}) {
  for (let o = 0; o < r.length; o++) {
    ...
    if (s2.kind === "context") {
      if (I2(s2.nodes, t, i, { ...e, ...s2.context }) === 2) return 2;
      continue;
    }
    i.push(s2);
    let d2 = false, u2 = 0, f2 = t(s2, { parent: l3, context: e, path: i, replaceWith(g2) {
    ...
    if (v2.kind === "declaration") {
      ...
      if (i & 2 && v2.value.includes("color-mix(")) {
        ...
        if (X2(k2, (S, { replaceWith: O2 }) => {
          ...
          let S = { ...v2, value: H2(k2) }, O2 = W2("@supports (color: color-mix(in lab, red, red))", [v2]);
          w2.push(S, O2);
          return;
        }
      }
    ...
    for (let [l3, d2] of s2) switch (t.variants.kind(l3)) {
      ...
      case "functional": {
        ...
        if (d2[d2.length - 1] === "]") {
          ...
          return !se(f2) || f2.length === 0 || f2.trim().length === 0 ? null : { kind: "functional", root: l3, modifier: u2, value: { kind: "arbitrary", value: f2 } };
        }
        if (d2[d2.length - 1] === ")") {
          if (d2[0] !== "(") continue;
          let f2 = le(d2.slice(1, -1));
          return !se(f2) || f2.length === 0 || f2.trim().length === 0 || f2[0] !== "-" && f2[1] !== "-" ? null : { kind: "functional", root: l3, modifier: u2, value: { kind: "arbitrary", value: `var(${f2})` } };
        }
...
function Xt(r) {
  ...
  function o(n, c) {
    ...
    c.supportsNegative && t.functional(`-${n}`, p2({ negative: true })), t.functional(n, p2({ negative: false })), i(n, () => [{ supportsNegative: c.supportsNegative, valueThemeKeys: c.themeKeys ?? [], hasDefaultValue: c.defaultValue !== void 0 && c.defaultValue !== null, supportsFractions: c.supportsFractions }]);
  }
  function s2(n, c) {
    t.functional(n, (p2) => {
      if (!p2.value) return;
  ...
  function l3(n, c, p2, { supportsNegative: x = false, supportsFractions: y2 = false } = {}) {
  ...
  for (let [n, c] of [["inset", "inset"], ["inset-x", "inset-inline"], ["inset-y", "inset-block"], ["start", "inset-inline-start"], ["end", "inset-inline-end"], ["top", "top"], ["right", "right"], ["bottom", "bottom"], ["left", "left"]]) e(`${n}-auto`, [[c, "auto"]]), e(`${n}-full`, [[c, "100%"]]), e(`-${n}-full`, [[c, "-100%"]]), l3(n, ["--inset", "--spacing"], (p2) => [a(c, p2)], { supportsNegative: true, supportsFractions: true });
  ...
  for (let [n, c] of [["m", "margin"], ["mx", "margin-inline"], ["my", "margin-block"], ["ms", "margin-inline-start"], ["me", "margin-inline-end"], ["mt", "margin-top"], ["mr", "margin-right"], ["mb", "margin-bottom"], ["ml", "margin-left"]]) e(`${n}-auto`, [[c, "auto"]]), l3(n, ["--margin", "--spacing"], (p2) => [a(c, p2)], { supportsNegative: true });
  ...
  e("w-screen", [["width", "100vw"]]), e("min-w-screen", [["min-width", "100vw"]]), e("max-w-screen", [["max-width", "100vw"]]), e("h-screen", [["height", "100vh"]]), e("min-h-screen", [["min-height", "100vh"]]), e("max-h-screen", [["max-height", "100vh"]]), e("max-w-none", [["max-width", "none"]]), e("max-h-none", [["max-height", "none"]]), l3("size", ["--size", "--spacing"], (n) => [a("--tw-sort", "size"), a("width", n), a("height", n)], { supportsFractions: true });
  for (let [n, c, p2] of [["w", ["--width", "--spacing", "--container"], "width"], ["min-w", ["--min-width", "--spacing", "--container"], "min-width"], ["max-w", ["--max-width", "--spacing", "--container"], "max-width"], ["h", ["--height", "--spacing"], "height"], ["min-h", ["--min-height", "--height", "--spacing"], "min-height"], ["max-h", ["--max-height", "--height", "--spacing"], "max-height"]]) l3(n, c, (x) => [a(p2, x)], { supportsFractions: true });
  t.static("container", () => {
  ...
  for (let n of ["x", "y"]) e(`-translate-${n}-full`, [u2, [`--tw-translate-${n}`, "-100%"], ["translate", "var(--tw-translate-x) var(--tw-translate-y)"]]), e(`translate-${n}-full`, [u2, [`--tw-translate-${n}`, "100%"], ["translate", "var(--tw-translate-x) var(--tw-translate-y)"]]), l3(`translate-${n}`, ["--translate", "--spacing"], (c) => [u2(), a(`--tw-translate-${n}`, c), a("translate", "var(--tw-translate-x) var(--tw-translate-y)")], { supportsNegative: true, supportsFractions: true });
  ...
  t.functional("-rotate", m({ negative: true })), t.functional("rotate", m({ negative: false })), i("rotate", () => [{ supportsNegative: true, values: ["0", "1", "2", "3", "6", "12", "45", "90", "180"], valueThemeKeys: ["--rotate"] }]);
  {
    ...
    for (let p2 of ["x", "y", "z"]) o(`rotate-${p2}`, { supportsNegative: true, themeKeys: ["--rotate"], handleBareValue: ({ value: x }) => p(x) ? `${x}deg` : null, handle: (x) => [c(), a(`--tw-rotate-${p2}`, `rotate${p2.toUpperCase()}(${x})`), a("transform", n)] }), i(`rotate-${p2}`, () => [{ supportsNegative: true, values: ["0", "1", "2", "3", "6", "12", "45", "90", "180"], valueThemeKeys: ["--rotate"] }]);
    o("skew", { supportsNegative: true, themeKeys: ["--skew"], handleBareValue: ({ value: p2 }) => p(p2) ? `${p2}deg` : null, handle: (p2) => [c(), a("--tw-skew-x", `skewX(${p2})`), a("--tw-skew-y", `skewY(${p2})`), a("transform", n)] }), o("skew-x", { supportsNegative: true, themeKeys: ["--skew"], handleBareValue: ({ value: p2 }) => p(p2) ? `${p2}deg` : null, handle: (p2) => [c(), a("--tw-skew-x", `skewX(${p2})`), a("transform", n)] }), o("skew-y", { supportsNegative: true, themeKeys: ["--skew"], handleBareValue: ({ value: p2 }) => p(p2) ? `${p2}deg` : null, handle: (p2) => [c(), a("--tw-skew-y", `skewY(${p2})`), a("transform", n)] }), i("skew", () => [{ supportsNegative: true, values: ["0", "1", "2", "3", "6", "12"], valueThemeKeys: ["--skew"] }]), i("skew-x", () => [{ supportsNegative: true, values: ["0", "1", "2", "3", "6", "12"], valueThemeKeys: ["--skew"] }]), i("skew-y", () => [{ supportsNegative: true, values: ["0", "1", "2", "3", "6", "12"], valueThemeKeys: ["--skew"] }]), t.functional("transform", (p2) => {
  ...
  }, handle: (n) => [a("font-stretch", n)] }), i("font-stretch", () => [{ values: ["50%", "75%", "90%", "95%", "100%", "105%", "110%", "125%", "150%", "200%"] }]), s2("placeholder", { themeKeys: ["--background-color", "--color"], handle: (n) => [F2("&::placeholder", [a("--tw-sort", "placeholder-color"), a("color", n)])] }), e("decoration-solid", [["text-decoration-style", "solid"]]), e("decoration-double", [["text-decoration-style", "double"]]), e("decoration-dotted", [["text-decoration-style", "dotted"]]), e("decoration-dashed", [["text-decoration-style", "dashed"]]), e("decoration-wavy", [["text-decoration-style", "wavy"]]), e("decoration-auto", [["text-decoration-thickness", "auto"]]), e("decoration-from-font", [["text-decoration-thickness", "from-font"]]), t.functional("decoration", (n) => {
    if (n.value) {
      if (n.value.kind === "arbitrary") {
        let c = n.value.value;
  ...
  }), i("decoration", () => [{ values: ["current", "inherit", "transparent"], valueThemeKeys: ["--text-decoration-color", "--color"], modifiers: Array.from({ length: 21 }, (n, c) => `${c * 5}`) }, { values: ["0", "1", "2"], valueThemeKeys: ["--text-decoration-thickness"] }]), e("animate-none", [["animation", "none"]]), o("animate", { themeKeys: ["--animate"], handle: (n) => [a("animation", n)] });
  {
    ...
    }), o("blur", { themeKeys: ["--blur"], handle: (y2) => [p2(), a("--tw-blur", `blur(${y2})`), a("filter", n)] }), e("blur-none", [p2, ["--tw-blur", " "], ["filter", n]]), o("backdrop-blur", { themeKeys: ["--backdrop-blur", "--blur"], handle: (y2) => [x(), a("--tw-backdrop-blur", `blur(${y2})`), a("-webkit-backdrop-filter", c), a("backdrop-filter", c)] }), e("backdrop-blur-none", [x, ["--tw-backdrop-blur", " "], ["-webkit-backdrop-filter", c], ["backdrop-filter", c]]), o("brightness", { themeKeys: ["--brightness"], handleBareValue: ({ value: y2 }) => p(y2) ? `${y2}%` : null, handle: (y2) => [p2(), a("--tw-brightness", `brightness(${y2})`), a("filter", n)] }), o("backdrop-brightness", { themeKeys: ["--backdrop-brightness", "--brightness"], handleBareValue: ({ value: y2 }) => p(y2) ? `${y2}%` : null, handle: (y2) => [x(), a("--tw-backdrop-brightness", `brightness(${y2})`), a("-webkit-backdrop-filter", c), a("backdrop-filter", c)] }), i("brightness", () => [{ values: ["0", "50", "75", "90", "95", "100", "105", "110", "125", "150", "200"], valueThemeKeys: ["--brightness"] }]), i("backdrop-brightness", () => [{ values: ["0", "50", "75", "90", "95", "100", "105", "110", "125", "150", "200"], valueThemeKeys: ["--backdrop-brightness", "--brightness"] }]), o("contrast", { themeKeys: ["--contrast"], handleBareValue: ({ value: y2 }) => p(y2) ? `${y2}%` : null, handle: (y2) => [p2(), a("--tw-contrast", `contrast(${y2})`), a("filter", n)] }), o("backdrop-contrast", { themeKeys: ["--backdrop-contrast", "--contrast"], handleBareValue: ({ value: y2 }) => p(y2) ? `${y2}%` : null, handle: (y2) => [x(), a("--tw-backdrop-contrast", `contrast(${y2})`), a("-webkit-backdrop-filter", c), a("backdrop-filter", c)] }), i("contrast", () => [{ values: ["0", "50", "75", "100", "125", "150", "200"], valueThemeKeys: ["--contrast"] }]), i("backdrop-contrast", () => [{ values: ["0", "50", "75", "100", "125", "150", "200"], valueThemeKeys: ["--backdrop-contrast", "--contrast"] }]), o("grayscale", { themeKeys: ["--grayscale"], handleBareValue: ({ value: y2 }) => p(y2) ? `${y2}%` : null, defaultValue: "100%", handle: (y2) => [p2(), a("--tw-grayscale", `grayscale(${y2})`), a("filter", n)] }), o("backdrop-grayscale", { themeKeys: ["--backdrop-grayscale", "--grayscale"], handleBareValue: ({ value: y2 }) => p(y2) ? `${y2}%` : null, defaultValue: "100%", handle: (y2) => [x(), a("--tw-backdrop-grayscale", `grayscale(${y2})`), a("-webkit-backdrop-filter", c), a("backdrop-filter", c)] }), i("grayscale", () => [{ values: ["0", "25", "50", "75", "100"], valueThemeKeys: ["--grayscale"], hasDefaultValue: true }]), i("backdrop-grayscale", () => [{ values: ["0", "25", "50", "75", "100"], valueThemeKeys: ["--backdrop-grayscale", "--grayscale"], hasDefaultValue: true }]), o("hue-rotate", { supportsNegative: true, themeKeys: ["--hue-rotate"], handleBareValue: ({ value: y2 }) => p(y2) ? `${y2}deg` : null, handle: (y2) => [p2(), a("--tw-hue-rotate", `hue-rotate(${y2})`), a("filter", n)] }), o("backdrop-hue-rotate", { supportsNegative: true, themeKeys: ["--backdrop-hue-rotate", "--hue-rotate"], handleBareValue: ({ value: y2 }) => p(y2) ? `${y2}deg` : null, handle: (y2) => [x(), a("--tw-backdrop-hue-rotate", `hue-rotate(${y2})`), a("-webkit-backdrop-filter", c), a("backdrop-filter", c)] }), i("hue-rotate", () => [{ values: ["0", "15", "30", "60", "90", "180"], valueThemeKeys: ["--hue-rotate"] }]), i("backdrop-hue-rotate", () => [{ values: ["0", "15", "30", "60", "90", "180"], valueThemeKeys: ["--backdrop-hue-rotate", "--hue-rotate"] }]), o("invert", { themeKeys: ["--invert"], handleBareValue: ({ value: y2 }) => p(y2) ? `${y2}%` : null, defaultValue: "100%", handle: (y2) => [p2(), a("--tw-invert", `invert(${y2})`), a("filter", n)] }), o("backdrop-invert", { themeKeys: ["--backdrop-invert", "--invert"], handleBareValue: ({ value: y2 }) => p(y2) ? `${y2}%` : null, defaultValue: "100%", handle: (y2) => [x(), a("--tw-backdrop-invert", `invert(${y2})`), a("-webkit-backdrop-filter", c), a("backdrop-filter", c)] }), i("invert", () => [{ values: ["0", "25", "50", "75", "100"], valueThemeKeys: ["--invert"], hasDefaultValue: true }]), i("backdrop-invert", () => [{ values: ["0", "25", "50", "75", "100"], valueThemeKeys: ["--backdrop-invert", "--invert"], hasDefaultValue: true }]), o("saturate", { themeKeys: ["--saturate"], handleBareValue: ({ value: y2 }) => p(y2) ? `${y2}%` : null, handle: (y2) => [p2(), a("--tw-saturate", `saturate(${y2})`), a("filter", n)] }), o("backdrop-saturate", { themeKeys: ["--backdrop-saturate", "--saturate"], handleBareValue: ({ value: y2 }) => p(y2) ? `${y2}%` : null, handle: (y2) => [x(), a("--tw-backdrop-saturate", `saturate(${y2})`), a("-webkit-backdrop-filter", c), a("backdrop-filter", c)] }), i("saturate", () => [{ values: ["0", "50", "100", "150", "200"], valueThemeKeys: ["--saturate"] }]), i("backdrop-saturate", () => [{ values: ["0", "50", "100", "150", "200"], valueThemeKeys: ["--backdrop-saturate", "--saturate"] }]), o("sepia", { themeKeys: ["--sepia"], handleBareValue: ({ value: y2 }) => p(y2) ? `${y2}%` : null, defaultValue: "100%", handle: (y2) => [p2(), a("--tw-sepia", `sepia(${y2})`), a("filter", n)] }), o("backdrop-sepia", { themeKeys: ["--backdrop-sepia", "--sepia"], handleBareValue: ({ value: y2 }) => p(y2) ? `${y2}%` : null, defaultValue: "100%", handle: (y2) => [x(), a("--tw-backdrop-sepia", `sepia(${y2})`), a("-webkit-backdrop-filter", c), a("backdrop-filter", c)] }), i("sepia", () => [{ values: ["0", "50", "100"], valueThemeKeys: ["--sepia"], hasDefaultValue: true }]), i("backdrop-sepia", () => [{ values: ["0", "50", "100"], valueThemeKeys: ["--backdrop-sepia", "--sepia"], hasDefaultValue: true }]), e("drop-shadow-none", [p2, ["--tw-drop-shadow", " "], ["filter", n]]), t.functional("drop-shadow", (y2) => {
      let $2;
    ...
    }), i("drop-shadow", () => [{ values: ["current", "inherit", "transparent"], valueThemeKeys: ["--drop-shadow-color", "--color"], modifiers: Array.from({ length: 21 }, (y2, $2) => `${$2 * 5}`) }, { valueThemeKeys: ["--drop-shadow"] }]), o("backdrop-opacity", { themeKeys: ["--backdrop-opacity", "--opacity"], handleBareValue: ({ value: y2 }) => de(y2) ? `${y2}%` : null, handle: (y2) => [x(), a("--tw-backdrop-opacity", `opacity(${y2})`), a("-webkit-backdrop-filter", c), a("backdrop-filter", c)] }), i("backdrop-opacity", () => [{ values: Array.from({ length: 21 }, (y2, $2) => `${$2 * 5}`), valueThemeKeys: ["--backdrop-opacity", "--opacity"] }]);
  }
  {
  ...
  e("will-change-auto", [["will-change", "auto"]]), e("will-change-scroll", [["will-change", "scroll-position"]]), e("will-change-contents", [["will-change", "contents"]]), e("will-change-transform", [["will-change", "transform"]]), o("will-change", { themeKeys: [], handle: (n) => [a("will-change", n)] }), e("content-none", [["--tw-content", "none"], ["content", "none"]]), o("content", { themeKeys: [], handle: (n) => [D2([C2("--tw-content", '""')]), a("--tw-content", n), a("content", "var(--tw-content)")] });
  {
  ...
  e("forced-color-adjust-none", [["forced-color-adjust", "none"]]), e("forced-color-adjust-auto", [["forced-color-adjust", "auto"]]), e("leading-none", [() => D2([C2("--tw-leading")]), ["--tw-leading", "1"], ["line-height", "1"]]), l3("leading", ["--leading", "--spacing"], (n) => [D2([C2("--tw-leading")]), a("--tw-leading", n), a("line-height", n)]), o("tracking", { supportsNegative: true, themeKeys: ["--tracking"], handle: (n) => [D2([C2("--tw-tracking")]), a("--tw-tracking", n), a("letter-spacing", n)] }), e("antialiased", [["-webkit-font-smoothing", "antialiased"], ["-moz-osx-font-smoothing", "grayscale"]]), e("subpixel-antialiased", [["-webkit-font-smoothing", "auto"], ["-moz-osx-font-smoothing", "auto"]]);
  {
  ...
  }), i("text-shadow", () => [{ values: ["current", "inherit", "transparent"], valueThemeKeys: ["--text-shadow-color", "--color"], modifiers: Array.from({ length: 21 }, (n, c) => `${c * 5}`) }, { values: ["none"] }, { valueThemeKeys: ["--text-shadow"], modifiers: Array.from({ length: 21 }, (n, c) => `${c * 5}`), hasDefaultValue: true }]);
  {
    ...
    }), i("inset-shadow", () => [{ values: ["current", "inherit", "transparent"], valueThemeKeys: ["--box-shadow-color", "--color"], modifiers: Array.from({ length: 21 }, (N2, V2) => `${V2 * 5}`) }, { values: ["none"] }, { valueThemeKeys: ["--inset-shadow"], modifiers: Array.from({ length: 21 }, (N2, V2) => `${V2 * 5}`), hasDefaultValue: true }]), e("ring-inset", [p2, ["--tw-ring-inset", "inset"]]);
...
`);
      ...
      let o = [], s2 = [];
      for (let [l3, { literals: d2, usedSpacingNumber: u2, usedSpacingInteger: f2, themeKeys: g2 }] of [[o, e["--value"]], [s2, e["--modifier"]]]) {
...
function or(r, t) {
  var _a2;
  let { astNodes: i, nodeSorting: e } = ue2(Array.from(t), r), o = new Map(t.map((l3) => [l3, null])), s2 = 0n;
  for (let l3 of i) {
...
function sr(r) {
  let t = Xt(r), i = lr(r), e = new q2((u2) => Jt(u2, d2)), o = new q2((u2) => Array.from(Gt(u2, d2))), s2 = new q2((u2) => {
    ...
    let f2 = [];
    for (let g2 of u2) {
      let m = false, { astNodes: h2 } = ue2([g2], this, { onInvalidCandidate() {
        m = true;
      } });
...
function ue2(r, t, { onInvalidCandidate: i } = {}) {
...
${ee2([v2])}`);
  ...
  for (let m of u2) if ("nodes" in m) for (let h2 = 0; h2 < m.nodes.length; h2++) {
    ...
    {
      let A2 = ue2(w2, t, { onInvalidCandidate: (k2) => {
  ...
  return I2(r, (l3, { replaceWith: d2 }) => {
    if (l3.kind === "at-rule" && (l3.name === "@import" || l3.name === "@reference")) {
      ...
      return s2.push((async () => {
        ...
        let w2 = await i(f2, t), A2 = de2(w2.content);
        await wt(A2, w2.base, i, e + 1), v2.nodes = ki([re2({ base: w2.base }, A2)], g2, m, h2);
      })()), d2(v2), 1;
    }
  ...
  return function(o, s2) {
    ...
    let u2 = (() => {
      ...
      if (h2 !== null && typeof h2 == "object" && !Array.isArray(h2)) {
        ...
        for (let w2 in g2) w2 !== "__CSS_VALUES__" && (((_a2 = h2 == null ? void 0 : h2.__CSS_VALUES__) == null ? void 0 : _a2[w2]) & 4 && gr(v2, w2.split("-")) !== void 0 || (v2[pe2(w2)] = g2[w2]));
        return v2;
      }
...
function yt({ designSystem: r, ast: t, resolvedConfig: i, featuresRef: e, referenceMode: o }) {
  let s2 = { addBase(l3) {
    ...
    }, { compounds: he(typeof d2 == "string" ? [d2] : d2) }) : typeof d2 == "object" && r.variants.fromAst(l3, ie2(d2));
    ...
    for (let [g2, m] of Object.entries(l3)) {
      let h2 = function({ negative: v2 }) {
        return (w2) => {
          var _a2, _b;
          if (((_a2 = w2.value) == null ? void 0 : _a2.kind) === "arbitrary" && u2.length > 0 && !u2.includes("any") && (w2.value.dataType && !u2.includes(w2.value.dataType) || !w2.value.dataType && !pe(w2.value.value, u2))) return;
  ...
  }, theme: Ze(r, () => i.theme ?? {}, (l3) => l3), prefix(l3) {
    return l3;
  }, config(l3, d2) {
    let u2 = i;
    if (!l3) return u2;
...
function Fi(r) {
  var _a2;
  let t = /* @__PURE__ */ new Set(), i = Ze(r.design, () => r.theme, o), e = Object.assign(i, { theme: i, colors: l });
  function o(s2) {
...
function Dr(r, t) {
  ...
  if (Object.keys(i).length > 0) {
    ...
    t.variants.functional("aria", (u2, f2) => {
      let g2 = f2.value;
      return g2 && g2.kind === "named" && g2.value in i ? l3 == null ? void 0 : l3(u2, { ...f2, value: { kind: "arbitrary", value: i[g2.value] } }) : l3 == null ? void 0 : l3(u2, f2);
    }, { compounds: d2 });
  }
  if (Object.keys(e).length > 0) {
    ...
    t.variants.functional("supports", (u2, f2) => {
      let g2 = f2.value;
      return g2 && g2.kind === "named" && g2.value in e ? l3 == null ? void 0 : l3(u2, { ...f2, value: { kind: "arbitrary", value: e[g2.value] } }) : l3 == null ? void 0 : l3(u2, f2);
    }, { compounds: d2 });
  }
  if (Object.keys(o).length > 0) {
    ...
    t.variants.functional("data", (u2, f2) => {
      let g2 = f2.value;
      return g2 && g2.kind === "named" && g2.value in o ? l3 == null ? void 0 : l3(u2, { ...f2, value: { kind: "arbitrary", value: o[g2.value] } }) : l3 == null ? void 0 : l3(u2, f2);
    }, { compounds: d2 });
  }
}
var Mi = /^[a-z]+$/;
async function Ir({ designSystem: r, base: t, ast: i, loadModule: e, sources: o }) {
  let s2 = 0, l3 = [], d2 = [];
  I2(i, (m, { parent: h2, replaceWith: v2, context: w2 }) => {
    if (m.kind === "at-rule") {
      if (m.name === "@plugin") {
...
Using an object as a plugin option is currently only supported in JavaScript configuration files.`);
        ...
        l3.push([{ id: A2, base: w2.base, reference: !!w2.reference }, Object.keys(b2).length > 0 ? b2 : null]), v2([]), s2 |= 4;
        return;
      }
      if (m.name === "@config") {
  ...
  let [f2, g2] = await Promise.all([Promise.all(d2.map(async ({ id: m, base: h2, reference: v2 }) => {
    let w2 = await e(m, h2, "config");
    return { path: m, base: w2.base, config: w2.module, reference: v2 };
  })), Promise.all(l3.map(async ([{ id: m, base: h2, reference: v2 }, w2]) => {
    let A2 = await e(m, h2, "plugin");
    return { path: m, base: A2.base, plugin: A2.module, options: w2, reference: v2 };
  }))]);
  return s2 |= Ur({ designSystem: r, base: t, ast: i, sources: o, configs: f2, pluginDetails: g2 }), s2;
}
function Ur({ designSystem: r, base: t, ast: i, sources: e, configs: o, pluginDetails: s2 }) {
  ...
  if (!r.important && f2.important === true && (r.important = true), typeof f2.important == "string") {
    let b2 = f2.important;
    I2(i, (k2, { replaceWith: T2, parent: S }) => {
      if (k2.kind === "at-rule" && !(k2.name !== "@tailwind" || k2.params !== "utilities")) return (S == null ? void 0 : S.kind) === "rule" && S.selector === b2 ? 2 : (T2(F2(b2, [k2])), 2);
    });
  }
...
async function zr(r, { base: t = "", loadModule: i = Gi, loadStylesheet: e = Ji } = {}) {
  let o = 0;
  r = [re2({ base: t }, r)], o |= await wt(r, t, e);
  let s2 = null, l3 = new ze(), d2 = [], u2 = [], f2 = null, g2 = null, m = [], h2 = [], v2 = [], w2 = [], A2 = null;
  I2(r, (k2, { parent: T2, replaceWith: S, context: O2 }) => {
    if (k2.kind === "at-rule") {
      ...
      if (k2.name === "@media") {
        ...
        for (let R2 of P2) if (R2.startsWith("source(")) {
          let J2 = R2.slice(7, -1);
          I2(k2.nodes, (z2, { replaceWith: B2 }) => {
            if (z2.kind === "at-rule" && z2.name === "@tailwind" && z2.params === "utilities") return z2.params += ` source(${J2})`, B2([re2({ sourceBase: O2.base }, [z2])]), 2;
          });
        ...
        } else R2 === "important" ? s2 = true : R2 === "reference" ? k2.nodes = [re2({ reference: true }, k2.nodes)] : L2.push(R2);
...
${J2}`);
  ...
  if (f2) {
    ...
    for (let S of T2) r.push(re2({ theme: true }, [D2([S])]));
    f2.nodes = [re2({ theme: true }, k2)];
  }
  if (g2) {
    let k2 = g2;
  ...
  return o |= ke(r, b2), o |= Ee(r, b2), I2(r, (k2, { replaceWith: T2 }) => {
    if (k2.kind === "at-rule") return k2.name === "@utility" && T2([]), 1;
  }), { designSystem: b2, ast: r, sources: h2, root: A2, utilitiesNode: g2, features: o, inlineCandidates: v2 };
}
async function Hi(r, t = {}) {
  let { designSystem: i, ast: e, sources: o, root: s2, utilitiesNode: l3, features: d2, inlineCandidates: u2 } = await zr(r, t);
  ...
  return { sources: o, root: s2, features: d2, build(w2) {
    if (d2 === 0) return r;
    if (!l3) return m ?? (m = me(e, i, t.polyfills)), m;
    let A2 = v2, b2 = false;
    v2 = false;
    let k2 = g2.size;
    ...
    let T2 = ue2(g2, i, { onInvalidCandidate: f2 }).astNodes;
    return !b2 && h2 === T2.length ? (m ?? (m = me(e, i, t.polyfills)), m) : (h2 = T2.length, l3.nodes = T2, m = me(e, i, t.polyfills), m);
  } };
}
async function Xa(r, t = {}) {
  let i = de2(r), e = await Hi(i, t), o = i, s2 = r;
  return { ...e, build(l3) {
    let d2 = e.build(l3);
...
async function el(r, t = {}) {
  return (await zr(de2(r), t)).designSystem;
}
function Zi() {
